...
export default function MediaUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = mediaRecord
      ...
      : initialValues;
    setPlaybackId(cleanValues.playbackId);
  ...
  const [mediaRecord, setMediaRecord] = React.useState(media);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(Media, idProp) : media;
