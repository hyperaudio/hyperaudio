...
export default function RemixUpdateForm(props) {
  const {
    id: idProp,
    remix,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = remixRecord
      ? { ...initialValues, ...remixRecord }
      : initialValues;
  ...
  const [remixRecord, setRemixRecord] = React.useState(remix);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(Remix, idProp) : remix;
      setRemixRecord(record);
    };
    queryData();
  }, [idProp, remix]);
  React.useEffect(resetStateValues, [remixRecord]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Remix.copyOf(remixRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "RemixUpdateForm")}
      {...rest}
    >
      <TextField
        label="Url"
