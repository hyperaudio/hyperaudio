...
!(function (e, t) {
  ...
  function o(e) {
    for (
      var t = 'atchesSelector', n = ['matches', 'm' + t, 'webkitM' + t, 'mozM' + t, 'msM' + t, 'oM' + t], r = 0;
      r < n.length;
      r++
    ) {
      var o = n[r];
  ...
  function a(e, t) {
    if (t && 'object' === ('undefined' == typeof t ? 'undefined' : m(t))) for (var n in t) e[n] = t[n];
    return e;
  }
  function c(e) {
      ...
      return {
        init: function () {
          return (
            ...
            (S = g.defaultView),
            S.getSelection
              ? (C.forEach(t), S.addEventListener('resize', r), (M = v(g)), (h = !0))
